...
const TemplateFiveOptionGroup = ({ productDetails, onChangeSetProductVariant }) => {
    ...
    return (
        <div className="px-5">
            ...
            {productDetails?.options ? <div className="t5-color-brown mb-2 text-left text-big font-bold">Options:</div> : null}

            {productDetails?.options &&
                Object.keys(productDetails?.options).map((optionLabel, mainIndex) => (
                    <div className="grid grid-cols-3 my-1" key={mainIndex}>
                        <div className="text-big col-span-1 t5-color-brown mb-1 text-left capitalize mr-2">{optionLabel}</div>
                                    ...
                                    <li key={index} className="px-4">
                                        ...
                                        <label
                                            ...
                                            <div className="block w-full">
                                                <div className="w-full text-xs lg:text-big lg:font-semibold capitalize px-3">
                                                    {optionValue}
                                                </div>
                                            </div>
                                        </label>
...
export default TemplateFiveOptionGroup;
