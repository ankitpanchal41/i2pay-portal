...
const ContactSmsHistory = ({ contactId }) => {
    ...
    return (
        <div className="box shadow-lg mt-5">
            <div
                ...
                <div className="mr-auto text-center lg:text-left mt-3 lg:mt-0">
                                                    <span
                                                        className="font-medium text-primary dark:text-white text-lg">SMS History</span>
                </div>
            </div>
            <div
                                        ...
                                        smsHistory.map((sms, index) => (
                                            <tr className="border-b" key={index}>
                                                ...
                                                <td className="text-sm dark:text-white text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center">
                                                    <span
                                                        className="py-0.5 px-2 rounded-full text-xs text-white cursor-pointer font-medium bg-success">{sms?.count}</span>
                                                </td>
                                                <td className="text-sm dark:text-white text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center">
                                                    <button
