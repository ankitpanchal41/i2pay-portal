...
const CreateEmailCampaign = () => {
    ...
    }, [emailCampaignId, detailEmailCampaign]);
                                    ...
                                    <>
                                        ...
                                        <div className="intro-y bg-[#F4F5F880] p-[30px] mt-2">
                                            ...
                                            <div className={sectionVisible === 2 ? "" : "hidden"}>
                                                <Step2
                                                    id={currentId ? currentId : emailCampaignId}
                                                    onSaveCurrentStep={(step) => {
                                                        setCurrentStep(step);
                                                    }}
                                                    onChangeSection={() => {
                                        ...
                                        <div className="intro-y bg-[#F4F5F880] p-[30px] mt-2">
                                                    ...
                                                    <div>
                                                        {currentStep > 2 && (
                                                            <span
                                                                onClick={() => {
                                                                    navigate(
                                                                        `/email-template/create/${currentId ? currentId : emailCampaignId}`,
                                                                    );
                                                                }}
                                            ...
                                            <div className={sectionVisible === 3 ? "" : "hidden"}>
                                                <Step3 id={currentId ? currentId : emailCampaignId} />
                                            </div>
                                        </div>
