                ...
                <div className="api-document-menu">
                    <Scrollspy
                        ...
                        <li
                            ...
                            <a>Modify Email Campaign</a>
                        </li>

                        <li
                            className="scroll-to-link"
                            data-target="send-email-campaign"
                            onClick={(e) => goToSection("send-email-campaign", e)}>
                            <a>Send Email Campaign</a>
                        </li>
            ...
            <div className="api-document-page">
                <div ref={myRef} className="api-document api-document-single-content">
                    ...
                    <div className="overflow-hidden api-document-section" id="how-to-create-sms-template">
                        <h2>How to create email campaign</h2>
                        <p>
                            First of all, go to the{" "}
                            <a href={process.env.REACT_APP_MERCHANT_URL + `email-campaigns`} target="_blank">
                                Email Campaigns
                            </a>{" "}
                            page as shown. You will get all of the available campaigns listed there.
                        </p>
                        <p>
                            After that, click on the <strong>Add Campaign</strong> to create a new email campaign template.
                        </p>
                        <div className="api-document-detail">
                            <img
                                onClick={() => {
                                    onClickBanner("images/email-campaign/add-email-campaign.png");
                                }}
                                className="api-document-detail-image shadow-lg document-image-border"
                                alt="Email Campaign Listing"
                                title="Email Campaign Listing"
                                src="images/email-campaign/add-email-campaign.png"
                            />
                        </div>

                        <p>You can create a new email campaign template as shown below.</p>

                        <div className="api-document-detail">
                            <img
                                onClick={() => {
                                    onClickBanner("images/email-campaign/add-email-campaign-2.png");
                                }}
                                className="api-document-detail-image shadow-lg document-image-border"
                                alt="Add Email Campaign"
                                title="Add Email Campaign"
                                src="images/email-campaign/add-email-campaign-2.png"
                            />
                        </div>

                        <p>
                            In the create email campaign section enter <strong>campaign name</strong> and <strong>campaign subject</strong>{" "}
                            and save it to start.
                        </p>
                        <p>After that, select the contact group you've previously created. Also, you can other emails from this section.</p>

                        <div className="api-document-detail">
                            <img
                                onClick={() => {
                                    onClickBanner("images/email-campaign/add-contact-group.png");
                                }}
                                className="api-document-detail-image shadow-lg document-image-border"
                                alt="Add Contact Group"
                                title="Add Contact Group"
                                src="images/email-campaign/add-contact-group.png"
                            />
                        </div>

                        <p>
                            Next, in the design section select the design template you want to send in the email to receive payment. Click
                            on the <strong>Use Template</strong> button to select template. You can also preview the template before using
                            it.
                        </p>
                        ...
                        <div className="api-document-detail">
                            <img
                                onClick={() => {
                                    onClickBanner("images/email-campaign/select-template.png");
                                }}
                                className="api-document-detail-image shadow-lg document-image-border"
                                alt="Select Template"
                                title="Select Template"
                                src="images/email-campaign/select-template.png"
                            />
                        </div>

                        <p>
                            Selecting any template will redirect you to template builder. You can modify that template as you want with drag
                            and drop functionality.
                        </p>

                        <p>
                            In the following section you can select any html prebuild components, column grids and lots of design properties
                            to build your custom email template.
                        </p>
                        <div className="api-document-detail">
                            <img
                                onClick={() => {
                                    onClickBanner("images/email-campaign/predefined-selected-template.png");
                                }}
                                className="api-document-detail-image shadow-lg document-image-border"
                                alt="Predefined Selected Template"
                                title="Predefined Selected Template"
                                src="images/email-campaign/predefined-selected-template.png"
                            />
                        </div>

                        <p>Also, in the button element you can add your payment link to receive the payment as shown below.</p>
                        <div className="api-document-detail">
                            <img
                                onClick={() => {
                                    onClickBanner("images/email-campaign/payment-button.png");
                                }}
                                className="api-document-detail-image shadow-lg document-image-border"
                                alt="Payment Button"
                                title="Payment Button"
                                src="images/email-campaign/payment-button.png"
                            />
                        </div>

                        <p>Finally, your email template is ready to receive payment. Click on <strong>Save</strong> button to create your template.</p>
                    ...
                    <div className="overflow-hidden api-document-section" id="modify-sms-template">
                        <h2>Modify Email Campaign</h2>
                        <p>
                            You can <strong>Modify</strong>, <strong>Delete</strong> and <strong>Preview</strong> template as shown
                            below.
                        </p>
                        <div className="api-document-detail">
                            <img
                                onClick={() => {
                                    onClickBanner("images/email-campaign/modify-email-template.png");
                                }}
                                className="api-document-detail-image shadow-lg document-image-border"
                                alt="Modify Email Campaign Template"
                                title="Modify Email Campaign Template"
                                src="images/email-campaign/modify-email-template.png"
                            />
                        </div>
                    </div>
                    ...
                    <div className="overflow-hidden api-document-section" id="send-email-campaign">
                        <h2>Send Email Campaign</h2>
                        <p>
                            You can send <strong>Email Campaign</strong> by clicking{" "}
                            <strong>
                                <Icon.Send className="inline-block" size={15} color="#000000"/>
                            </strong> &nbsp; 
                            button. Email will automatically been send to the selected contacts group with using this button.
                        </p>
                        <div className="api-document-detail">
                            <img
                                onClick={() => {
                                    onClickBanner("images/email-campaign/send-email-campaign.png");
                                }}
                                className="api-document-detail-image shadow-lg document-image-border"
                                alt="Send Email Campaign"
                                title="Send Email Campaign"
                                src="images/email-campaign/send-email-campaign.png"
                            />
                        </div>
                    </div>
