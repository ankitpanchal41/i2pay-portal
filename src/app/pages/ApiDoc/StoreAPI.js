        ...
        <>
            ...
            <div className="left-menu">
                ...
                <div className="api-document-menu">
                    <Scrollspy items={["how-to-integrate-api", "store-transaction", "3ds-url-redirection"]} currentClassName="active">
                        <li
                        ...
                        <li className="scroll-to-link" data-target="store-transaction" onClick={(e) => goToSection("store-transaction", e)}>
            ...
            <div className="api-document-page">
                ...
                <div ref={myRef} className="api-document">
                    ...
                    <div className="overflow-hidden api-document-section mt-12" id="store-transaction">
                        <SyntaxHighlighter language="json" style={dark}>
                            {`
API Endpoint
    Live url : ${process.env.REACT_APP_API_URL}payment/store/transaction
`}
                        </SyntaxHighlighter>
                        ...
                        <p>
                            ...
                            <code className="higlighted break-word">{process.env.REACT_APP_API_URL}payment/store/transaction</code>
                        </p>
                        <br />
                        <SyntaxHighlighter language="json" style={dark}>
                            {`
...

{
    ...
    "redirect_url": "${process.env.REACT_APP_API_URL}test/connectors/CSAE1653196475"
                        ...
                        <div className="api-document-detail max-w-[50%] mt-[-15px]">
                            <img
                                onClick={() => {
                                    onClickBanner("images/directPaymentAPI/store-transaction-connector-7.png");
                                }}
                                className="api-document-detail-image document-image-border"
                                alt="Create API Key"
        ...
        "validation": [
            ...
            "The return url field is required."
                    ...
                    <div className="overflow-hidden api-document-section" id="3ds-url-redirection">
                        ...
                        <div className="mt-8">
                            <p>
                                <strong className="text-danger">Note :</strong> Make sure that <strong>"webhook_url"</strong> is not secured
                                by token and able to get external requests
                            </p>
                            <p>
